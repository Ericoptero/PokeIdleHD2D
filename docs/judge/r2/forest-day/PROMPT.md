# Blind comparison — packet `forest-day`

Two screenshots, `A.png` and `B.png`, both 720x480. One is from a shipped
...
Which is the more convincing, better-looking overworld route?
